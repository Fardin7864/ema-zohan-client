    ...
    <div className="navbar bg-[#1C2B35] fixed top-0 z-50">
      <div className="navbar-start">
        ...
        <Link to="/" className="flex flex-col gap-1">
            <h3 id="logo" className="text-white text-3xl font-extrabold">Ema-John</h3>
            <div className="pl-8 -mt-2"><svg xmlns="http://www.w3.org/2000/svg" width="58" height="10" viewBox="0 0 58 10" fill="none">
